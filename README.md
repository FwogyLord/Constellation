...
- **hercules** — farming. Garden visitor shopping, prices, sack availability, rewards and safeguards; advisory target speed/angles, yaw/pitch, crop rates, profile-safe Crop Milestone progress/ETA/goals, per-crop farming-lane distance/switch guidance with automatic or manual locations, specialized hoe levels/overflow, DNA Analyzer solver, true Farming Fortune, crop start/last-farmed waypoints, reversible farming mouse sensitivity, Garden warp commands/hotkeys and Jacob contest progress; Garden pest spawn alerts, finder borders, cooldown timer, kill/drop/profit statistics, custom plot-name learning, vacuum particle-path waypoints, persistent plot-spray expiry tracking, Configure Plots status highlighting and custom icons, Stereo Harmony vinyl/crop guidance and Greenhouse growth diagnostics
